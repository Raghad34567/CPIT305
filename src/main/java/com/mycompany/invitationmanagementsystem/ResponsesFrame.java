...
public class ResponsesFrame extends JFrame implements RSVPObserver {
    ...
    public ResponsesFrame(DashboardFrame dashboard) {
        ...
        // Observer Pattern: subscribe to RSVP notifications when this frame opens.
        RSVPFrame.addObserver(this);
    ...
    /*
     * Observer Pattern:
     * This method is called automatically by RSVPFrame when a guest submits an RSVP.
     * It refreshes the table and shows a popup notification to the organizer.
     */
    @Override
    public void onRSVPReceived(String guestName, String response) {
        // Run on the Swing event thread to safely update the GUI.
        SwingUtilities.invokeLater(() -> {
            // Refresh the table to show the new response.
            loadResponses();
 
            // Show a popup notification to the organizer.
            JOptionPane.showMessageDialog(
                    this,
                    guestName + " just responded: " + response,
                    "New RSVP Received",
